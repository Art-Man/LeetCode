...
public class P27RemoveElement {
    public static void main(String[] args) {
        ...
        // TO TEST
        System.out.printf(solution.removeElement(new int[]{3,2,2,3}, 3)+"\n");
        System.out.printf(solution.removeElement(new int[]{0,1,2,2,3,0,4,2}, 2)+"\n");
    }
